    ...
    if(isset($_POST['submitButton'])){
        ...
        if($poseName != "" 
           ...
           && $instructionalVid != ""){
            ...
            $query = "INSERT INTO Pose (pose_name, image, instruct_vid_youtube_id, difficulty, sanskrit_name) VALUES ('$poseName', '$image', '$instructionalVid', '$difficulty', '$sanskritName')";
        ...
        <section class="col-sm-10 col-sm-offset-1">
            <div id="body-panel" class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="addPose.php">
                        <div class="form-group">
                            <label for="poseName">Pose Name: </label>
                            <input name="poseName" class="form-control" type="text" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="instructionalVid" class="form-control" type="text" required />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="sanskritName" class="form-control" type="text" />
                        </div>
                        <div class="checkbox">
